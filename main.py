...
from id_minimax_edit_agent import IDMinimaxEditAgent
...
def main():
    ...
    # players = [IDMinimaxEditAgent, IDMinimaxAgent]   # <-- Uncomment this to test your agent
    players = [IDMinimaxEditAgent, MarkovAgent]
    ###############################################
    ...
    for i in range(5):
        ...
        for round in range(len(players)):
            ...
            if "edit" in player_name(players[0]):
            ...
            print("my_won : opp_won", my_won, " : ", opp_won)
            print("########################################################")
